 ...
 * React Portals.
 *
 * 获取产物标题与内容的无头组件，并通过 React Portal 将其渲染到
 * `ArtifactContent` 和 `ArtifactTitle` 组件所在位置。
 */
 ...
 *
 * 提供传入 `LoadExternalComponent` 的 `meta.artifact` 字段的值，
 * 供生成式 UI 侧的 `useArtifact` hook 使用。
 */

...
export function createDefaultHumanResponse(
  ...
  // Choose the default action in approve, reject, edit order. / 按批准、拒绝、编辑的顺序选择默认操作。
...
export function constructOpenInStudioURL(
  ...
  // Trim the trailing slash from the deployment URL. / 移除部署 URL 末尾的斜杠。
